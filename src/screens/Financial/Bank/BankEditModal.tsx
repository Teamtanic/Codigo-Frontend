...
export function BankEditModal(){
    return (
        <CardModal title="Editar Banco" action="Editar Banco" triggerStyle="!w-full !bg-transparent !shadow-none hover:!bg-gray-200 hover:dark:!bg-gray-600 bottom-3 !text-gray-100 !font-normal">
