...
export function ListPrivileges() {
    ...
    var privileges = [
        { id: "75b6a6f8-88fb-4642-bd79-60cd4865691c", name: "canWriteUser", description: "Pode manipular dados do módulo de Usuários" },
        { id: "ad24ccc1-efe2-4b17-8bbe-05a4e730b12a", name: "canWriteCompany", description: "Pode manipular dados do módulo de Empresas" },
        { id: "f5537fec-16f2-452b-a6e4-4e60d36f5686", name: "canWriteFunancial", description: "Pode manipular dados do módulo Financeiro" },
        { id: "3f506407-4638-4bd0-abb9-d2bcf415239c", name: "canWriteProject", description: "Pode manipular dados do módulo de Projetos" },
        { id: "78e1efba-f2d1-473c-b656-8f70c9e8a94c", name: "canWriteDocument", description: "Pode manipular dados do módulo de Documentos" },
        { id: "277dc916-e89e-444d-ac02-3bab065e488d", name: "canWriteAdmin", description: "Pode manipular dados de todos os módulos" },
        { id: "7ab0ac84-4500-4d68-907c-1ef5ed21d9ad", name: "canViewAdmin", description: "Pode ver dados de todos os módulos" },
    ];
    ...
    return (
        <Container>
            ...
            <div className="w-full flex py-6 p-24 max-md:p-6 flex-col">
                <Heading size="lg">Privilegios de Usuário</Heading>
                        ...
                        <table className="w-full border-separate border-spacing-y-4 ">
                                ...
                                <Card asChild  >
                                    <tr className="w-full py-3 text-left dark:border-gray-700 ">
                                        <th className="py-3 px-4 rounded-bl-none rounded-tl-2xl items-center border-r-4 border-gray-700">
                                            <Heading className="!text-gray-800">Curso</Heading>
                                        </th>
                                        <th className="px-4 w-96 max-md:rounded-r-2xl">
                                            <Heading className="!text-gray-800">Funcionários</Heading>
                                        </th>
                            ...
                            <tbody>
                                {privileges.map(privilege => {
                                    return (
                                        <Card asChild key={privilege.id} className="cursor-pointer hover:bg-gray-400 
                                        shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
                                            <tr className="h-16 dark:border-gray-700">
                                                <td className="px-2 py-4 rounded-l-xl">
                                                    <Text className="!text-gray-800 max-h-10 truncate font-semibold">{privilege.name}</Text>
                                                </td>
                                                <td className="px-2 py-4 max-md:rounded-r-xl">
                                                    <Text className="!text-gray-800 max-h-10 truncate font-semibold">{privilege.description}</Text>
                                                </td>
