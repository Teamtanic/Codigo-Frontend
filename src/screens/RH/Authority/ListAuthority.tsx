                    ...
                    <div className="mt-10">
                        <table className="w-full border-separate border-spacing-y-4 ">
                            ...
                            <tbody>
                                {courses.map(course => {
                                    return (
                                        <Card asChild key={course.id} className="cursor-pointer hover:bg-gray-400 
                                        shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
                                            <tr className="h-16 dark:border-gray-700">
                                                <td className="px-2 py-4 rounded-l-xl">
                                                    <Text className="!text-gray-800 max-h-10 truncate font-semibold">{course.name}</Text>
                                                </td>
                                                <td className="px-2 py-4 max-md:rounded-r-xl">
                                                    <Text className="!text-gray-800 max-h-10 truncate font-semibold">{course.employees} {course.employees === 1 ? 'funcionário' : 'funcionários'}</Text>
                                                </td>
