...
export function DepartmentAddModal() {
    return (
        <CardModal title="Cadastro de Departamento" action="Adicionar" triggerStyle="fixed w-fit bottom-5 right-8 rounded shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px] !text-gray-100">
