        ...
        <nav className="flex-1 space-y-2 px-4 py-4">
          {menuItems.map((item, index) => (
            ...
            >
                ...
                {
                    item.notify ? <span className="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-emerald-800 bg-green-300 rounded-full dark:bg-green-500 dark:text-emerald-900">{item.notify}</span> : ""
                }
            </Link>
          ))}
        </nav>
